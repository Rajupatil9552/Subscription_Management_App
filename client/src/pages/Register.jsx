...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (res && res.success) {
            ...
            setErrorMsg(res?.message || 'User already exists');
        }
    };
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-indigo-50 to-blue-100 py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
            <div className="absolute top-0 right-0 w-96 h-96 bg-violet-200 rounded-full opacity-20 blur-3xl translate-x-1/2 -translate-y-1/2 pointer-events-none" />
            <div className="absolute bottom-0 left-0 w-80 h-80 bg-indigo-200 rounded-full opacity-20 blur-3xl -translate-x-1/3 translate-y-1/3 pointer-events-none" />
            ...
            >
                ...
                >
                    ...
                    <p className="mt-1 text-sm text-gray-500">Get started with a free account today</p>
                </motion.div>
